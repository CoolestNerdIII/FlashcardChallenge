...
- (void)viewDidLoad
{
    ...
    NSString *Title = @"Select Mode for ";
    ...
    section1Subtitles = [[NSArray alloc] initWithObjects:@"See Question, Flip for Answer", @"Test your knowledge", @"Test your knoeledge with friends", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        case 1:
            if (indexPath.row == 0)
                cell.textLabel.text = [NSString stringWithFormat:@"%lu %@", (unsigned long)self.deck.cards.count, @"cards in the deck"];
            else
